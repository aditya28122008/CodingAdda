...
const page = () => {
  return (
    <div> 
      <div className="h-full w-[100%] rounded-md">
        <img
          src={"/code-1076536_640.jpg"}
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">
              Express your ideas about coding here !
            </h1>
          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/3 md:w-1/2 p-4 hover:scale-110 transition-transform duration-300 cursor-pointer hover:drop-shadow-lg">
